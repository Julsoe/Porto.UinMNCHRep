...
import pro202.exam.UinMNCH.databinding.ActivityCodeBinding

class CodeTaskActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnNext?.setOnClickListener {
            ...
            if (answer == taskList!![currentTaskPosition].getAnswer()) {
                Constants.updateTask("task3", true, 1)
                val intent = Intent(this, ObserveTaskActivity::class.java)
