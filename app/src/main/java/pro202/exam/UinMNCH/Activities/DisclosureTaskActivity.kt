...
import pro202.exam.UinMNCH.databinding.ActivityDisclosureBinding

class DisclosureTaskActivity : AppCompatActivity() {

    // initiation of the variables
    private var binding : ActivityDisclosureBinding? = null
    ...
    private var currentTaskPosition = 2
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnNext?.setOnClickListener {
            ...
            if (answer == taskList!![currentTaskPosition].getAnswer()) {
                Constants.updateTask("task6", true, 1)
                val intent = Intent(this, TourEndActivity::class.java)
